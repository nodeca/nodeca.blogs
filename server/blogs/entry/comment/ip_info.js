...
module.exports = function (N, apiPath) {
  ...
  // Fetch comment IP
  //
  N.wire.on(apiPath, async function fetch_comment_ip(env) {
    let comment = await N.models.blogs.BlogComment.findById(env.params.comment_id)
                          .select('ip')
                          .lean(true);
    ...
    env.res.ip = env.data.ip = comment.ip;
  });
