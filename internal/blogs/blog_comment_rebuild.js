// Get a blog comment from the database, rebuild it and write it back
//
'use strict';
...
module.exports = function (N, apiPath) {
  ...
  N.wire.on(apiPath, async function rebuild_blog_comment(id) {
    let post = await N.models.blogs.BlogComment.findById(id).lean(true);
    ...
    await N.models.blogs.BlogComment.update({ _id: post._id }, updateData);
  });
};
